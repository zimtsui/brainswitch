...
export namespace OpenAIResponsesNativeEngine {
    ...
    export class Instance<in out fdm extends Function.Declaration.Map> implements OpenAIResponsesNativeEngine.Instance<fdm> {
        ...
        protected openAIResponsesNativeEngineBase: OpenAIResponsesNativeEngine.Base<fdm>;
        ...
        public constructor(options: OpenAIResponsesNativeEngine.Options<fdm>) {
            ...
            this.openAIResponsesNativeEngineBase = new OpenAIResponsesNativeEngine.Base.Instance<fdm>(this, options);
        }
